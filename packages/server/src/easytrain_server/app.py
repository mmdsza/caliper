"""FastAPI app for the EasyTrain dry-run backend."""

from __future__ import annotations

from typing import Any

from easytrain_sdk import GraderLoadError, RunReport
from easytrain_store import EvalSetNotFound, EvalSetStore
from fastapi import FastAPI, HTTPException, Request
from fastapi.middleware.cors import CORSMiddleware
from pydantic import BaseModel, Field

from easytrain_server._seed import seed_default_eval_sets
from easytrain_server._store_factory import build_store_from_env
...
def create_app(
    ...
    *,
    ...
    app = FastAPI(title="EasyTrain dry-run backend", version="0.0.1")
