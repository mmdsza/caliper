"""Compile Caliper grader specs to OpenAI RFT JSON.

The spec types live in :mod:`caliper_rft.spec`. This module turns a typed
...
from caliper_rft.spec import AnyGrader, MultiGrader, ScoreModelGrader
